  ...
  return (
    <div className="flex h-screen items-center justify-center bg-indigo-500/20 p-6 md:p-0">
            <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%]">
                ...
                <div className="relative hidden h-full items-center justify-center bg-indigo-500 md:flex md:w-[60%] lg:w-[40%]">
                ...
                <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
                    ...
                    <form className="flex  w-full flex-col items-center justify-center gap-4">
                        ...
                        <input className="w-[80%] rounded-lg bg-indigo-500 hover: px-6 py-2 font-medium text-white md:w-[60%]" type="submit" />
                    </form>
                    {/* divider  */}
